...
const LoginForm: React.FC = () => {
  ...
  const { login, isLoading, error, isAuthenticated, setUiPreference } =
    useAuthStore();
      ...
      <Card className="w-full max-w-xl shadow-md p-6">
        ...
        <div className="text-center mt-6">
          <span
            ...
            className="text-gray-400 hover:text-gray-600 text-sm cursor-pointer inline-block"
          >
            Don't like the new UI? Switch back to classic view
          </span>
        </div>
      </Card>
    </div>
